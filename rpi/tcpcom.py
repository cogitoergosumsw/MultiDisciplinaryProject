...
class TCPServer(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            print
            "Fatal error while creating TCPServer: Bind failed.", msg[0], msg[1]
            sys.exit()
        try:
            self.serverSocket.listen(10)
        except:
            print
            "Fatal error while creating TCPServer: Port", self.port, "already in use"
            try:
                self.stateChanged(TCPServer.PORT_IN_USE, str(self.port))
            except Exception, e:
                print
                "Caught exception in TCPServer.PORT_IN_USE:", e
            sys.exit()
        ...
        try:
            ...
            print
            "Caught exception in TCPServer.LISTENING:", e
        ...
        while True:
            ...
            try:
                ...
                print
                "Caught exception in TCPServer.CONNECTED:", e
        self.conn.close()
        ...
        try:
            ...
            print
            "Caught exception in TCPServer.TERMINATED:", e
        self.isServerRunning = False
            ...
            while True:
                ...
                for i in range(len(junk) - 1):
                    try:
                        ...
                        print
                        "Caught exception in TCPServer.MESSAGE:", e
...
class TCPClient():
    ...
    def _waitForReply(self, responseTime):
        ...
        if self.receiverResponse == None:
            ...
            TCPClient.debug("Response = " + self.receiverResponse + " time elapsed: " + str(
                int(1000 * (time.time() - startTime))) + " ms")
    ...
    def connect(self, timeout=0):
        ...
        try:
            ...
            print
            "Caught exception in TCPClient.CONNECTING:", e
        try:
            ...
            try:
                ...
                print
                "Caught exception in TCPClient.CONNECTION_FAILED:", e
        ...
        if self.isRefused:
            ...
            try:
                ...
                print
                "Caught exception in TCPClient.SERVER_OCCUPIED:", e
            return False
        ...
        try:
            ...
            print
            "Caught exception in TCPClient.CONNECTED:", e
...
class ClientHandler(Thread):
    ...
    def run(self):
            ...
            try:
                ...
                for i in range(len(junk) - 1):
                    try:
                        ...
                        print
                        "Caught exception in TCPClient.MESSAGE:", e
            except:
        ...
        try:
            ...
            print
            "Caught exception in TCPClient.DISCONNECTED:", e
