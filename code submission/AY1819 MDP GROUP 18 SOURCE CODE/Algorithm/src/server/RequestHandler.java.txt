...
public class RequestHandler extends Thread {
	...
	public void sendReadings() {
		...
		send("SENSOR_DATA|0,0,0,1,1,1");
		send("SENSOR_DATA|4,4,4,1,1,2");
		send("SENSOR_DATA|3,4,4,1,1,3");
		send("SENSOR_DATA|2,3,4,1,1,4");
		send("SENSOR_DATA|1,3,4,1,1,0");
		send("SENSOR_DATA|1,1,1,0,0,1");
		send("SENSOR_DATA|1,3,4,1,1,0");
		send("SENSOR_DATA|0,4,3,4,1,0");
		send("SENSOR_DATA|0,3,2,0,3,2");
		send("SENSOR_DATA|3,4,0,2,2,0");
		send("SENSOR_DATA|2,3,0,1,2,0");
		send("SENSOR_DATA|1,2,0,1,2,0");
		send("SENSOR_DATA|3,1,1,0,4,1");
		send("SENSOR_DATA|1,2,0,1,2,0");
		send("SENSOR_DATA|0,0,0,0,1,4");
		send("SENSOR_DATA|0,0,0,0,2,3");
		send("SENSOR_DATA|2,0,0,2,3,0");
		send("SENSOR_DATA|1,0,4,1,2,2");
		send("SENSOR_DATA|2,0,0,0,1,4");
		send("SENSOR_DATA|1,0,0,0,0,3");
		send("SENSOR_DATA|0,0,0,2,3,1");
		send("SENSOR_DATA|0,0,4,1,3,1");
		send("SENSOR_DATA|0,0,4,3,2,1");
		send("SENSOR_DATA|0,0,4,3,1,1");
		send("SENSOR_DATA|0,0,4,3,3,1");
		send("SENSOR_DATA|3,3,4,0,0,0");
		send("SENSOR_DATA|2,2,3,1,0,0");
		send("SENSOR_DATA|1,1,2,2,0,0");
		send("SENSOR_DATA|0,0,4,2,1,2");
		send("SENSOR_DATA|0,4,4,2,1,2");
		send("SENSOR_DATA|4,4,4,2,2,0");
		send("SENSOR_DATA|2,2,2,3,0,4");
		send("SENSOR_DATA|1,1,1,1,3,4");
		send("SENSOR_DATA|4,4,4,1,1,0");
		send("SENSOR_DATA|3,3,3,1,1,0");
		send("SENSOR_DATA|2,2,2,1,1,0");
		send("SENSOR_DATA|1,1,1,1,1,0");
		send("SENSOR_DATA|1,1,1,4,0,1");
		send("SENSOR_DATA|1,1,1,1,1,0");
		send("SENSOR_DATA|0,0,0,1,1,0");
		send("SENSOR_DATA|0,0,0,1,1,0");
		send("SENSOR_DATA|0,0,0,1,1,0");
		send("SENSOR_DATA|0,0,0,1,1,0");
		send("SENSOR_DATA|0,0,4,1,1,2");
		send("SENSOR_DATA|0,0,4,1,1,0");
		send("SENSOR_DATA|0,0,0,1,1,0");
		...
		send("SENSOR_DATA|1,1,1,0,0,1");
		send("SENSOR_DATA|0,0,0,0,1,1");
		send("SENSOR_DATA|0,0,0,0,0,1");
		send("SENSOR_DATA|0,0,4,2,2,0");
		send("SENSOR_DATA|0,0,4,1,2,0");
		send("SENSOR_DATA|0,0,3,1,2,0");
		send("SENSOR_DATA|4,4,2,2,1,0");
		send("SENSOR_DATA|3,3,1,2,1,0");
		send("SENSOR_DATA|0,0,4,1,3,0");
		send("SENSOR_DATA|4,4,4,0,3,0");
		send("SENSOR_DATA|3,3,3,0,1,0");
		send("SENSOR_DATA|2,2,2,0,0,0");
		send("SENSOR_DATA|0,0,0,0,4,2");
		send("SENSOR_DATA|0,0,0,1,0,2");
		send("SENSOR_DATA|2,0,0,1,1,2");
		send("SENSOR_DATA|3,0,0,1,1,0");
		send("SENSOR_DATA|0,0,0,4,2,0");
		send("SENSOR_DATA|0,0,4,4,1,0");
		send("SENSOR_DATA|0,0,4,4,4,3");
		send("SENSOR_DATA|4,3,4,0,0,0");
		send("SENSOR_DATA|3,3,3,1,0,3");
		send("SENSOR_DATA|3,3,2,1,1,3");
		send("SENSOR_DATA|1,1,1,1,1,3");
		send("SENSOR_DATA|1,1,1,0,0,1");
		send("SENSOR_DATA|1,1,1,1,1,2");
		send("SENSOR_DATA|3,3,3,1,1,0");
		send("SENSOR_DATA|2,2,2,1,1,0");
		send("SENSOR_DATA|1,1,1,1,1,0");
		...
		send("SENSOR_DATA|0,4,0,0,1,0");
		send("SENSOR_DATA|4,3,0,0,0,0");
		send("SENSOR_DATA|0,0,4,4,4,4");
		send("SENSOR_DATA|4,0,4,1,4,0");
		send("SENSOR_DATA|3,4,4,3,4,0");
