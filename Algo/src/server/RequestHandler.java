...
send("SENSOR_DATA|3,0,0,1,1,3;");
send("SENSOR_DATA|2,0,0,1,1,3;");
send("SENSOR_DATA|1,0,0,1,1,3;");
send("SENSOR_DATA|3,3,3,0,1,3;");
send("SENSOR_DATA|2,2,2,0,0,3;");
send("SENSOR_DATA|0,0,0,2,2,2;");
send("SENSOR_DATA|0,0,4,1,2,2;");
send("SENSOR_DATA|0,0,0,3,2,2;");
send("SENSOR_DATA|0,0,4,3,1,2;");
send("SENSOR_DATA|0,0,4,3,3,0;");
send("SENSOR_DATA|3,3,3,0,0,0;");
send("SENSOR_DATA|2,2,2,1,0,4;");
send("SENSOR_DATA|1,1,1,1,0,2;");
send("SENSOR_DATA|2,0,4,1,1,4;");
send("SENSOR_DATA|1,0,4,1,1,4;");
send("SENSOR_DATA|4,3,4,0,1,0;");
send("SENSOR_DATA|3,2,3,0,0,0;");
send("SENSOR_DATA|0,0,4,2,2,3;");
send("SENSOR_DATA|0,0,4,1,2,3;");
send("SENSOR_DATA|4,4,4,2,2,3;");
send("SENSOR_DATA|3,3,3,2,1,3;");
send("SENSOR_DATA|2,2,2,2,2,3;");
send("SENSOR_DATA|2,2,2,0,0,2;");
send("SENSOR_DATA|1,1,1,1,0,2;");
send("SENSOR_DATA|2,2,2,1,1,4;");
send("SENSOR_DATA|1,1,1,1,1,4;");
send("SENSOR_DATA|4,4,4,1,1,0;");
send("SENSOR_DATA|3,3,3,1,1,0;");
send("SENSOR_DATA|2,2,2,1,1,0;");
send("SENSOR_DATA|1,1,1,1,1,0;");
send("SENSOR_DATA|4,0,0,1,1,4;");
send("SENSOR_DATA|3,0,0,1,1,4;");
send("SENSOR_DATA|2,0,0,1,1,3;");
send("SENSOR_DATA|1,0,0,1,1,4;");
send("SENSOR_DATA|4,3,4,0,1,4;");
send("SENSOR_DATA|3,2,3,0,0,4;");
send("SENSOR_DATA|2,1,2,4,0,4;");
send("SENSOR_DATA|0,0,4,3,3,2;");
send("SENSOR_DATA|0,0,3,2,4,2;");
send("SENSOR_DATA|0,0,2,3,2,2;");
send("SENSOR_DATA|0,0,1,3,2,2;");
send("SENSOR_DATA|2,2,2,1,0,0;");
send("SENSOR_DATA|1,1,1,1,2,2;");
send("SENSOR_DATA|2,0,4,1,1,3;");
send("SENSOR_DATA|1,0,4,1,1,4;");
send("SENSOR_DATA|4,3,4,0,1,0;");
