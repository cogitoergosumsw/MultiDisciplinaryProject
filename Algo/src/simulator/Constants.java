...
//	public static final int GOAL_COL = MAP_COL - 2;
	
	public static final int GOAL_ROW = 8;
	public static final int GOAL_COL = 3;
	public static final int MAP_SIZE = MAP_ROW * MAP_COL;
